-- Schema for Asset Manager
-- Use pgcrypto for gen_random_uuid() (recommended on Supabase)
...
begin
  ...
  -- Else: more than one profile -> no-op (must be promoted by an existing admin)
end;
$$;
